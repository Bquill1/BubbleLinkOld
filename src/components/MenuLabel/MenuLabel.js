...
class MenuLabel extends Component {
  ...
  render() {
    const { children, className, rootClassName, isOpen, isOpenClassName, disabled } = this.props;
    ...
    return (
      <button className={classes} onClick={this.onClick} onBlur={this.onBlur} disabled={disabled}>
        {children}
      </button>
    );
  }
