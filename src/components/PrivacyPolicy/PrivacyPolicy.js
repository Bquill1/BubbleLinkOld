...
const PrivacyPolicy = props => {
  ...
  return (
    <div className={classes}>
      ...
      <li> You also have the right to withdraw your consent at any time where BubbleLink relied on your consent to process your Personal Information.</li>
      </ul>
